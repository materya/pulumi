...
export class ClusterIssuer extends pulumi.CustomResource {
  ...
  private readonly inputs: inputApi.certmanager.v1alpha2.ClusterIssuer
  ...
  constructor (
    name: string,
    args?: inputApi.certmanager.v1alpha2.ClusterIssuer,
  ...
  public getInputs (): inputApi.certmanager.v1alpha2.ClusterIssuer {
    return this.inputs
  }
}
